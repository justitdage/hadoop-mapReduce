...
public class MyInputFormatMain extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        MyInputFormat.addInputPath(job,new Path("file:///D:\\work\\code\\ziliao\\5、自定义InputFormat实现小文件合并\\文件数据"));
...
//将我们的文件输出成为sequenceFile这种格式
        ...
        SequenceFileOutputFormat.setOutputPath(job,new Path("file:///D:\\work\\code\\ziliao\\5、自定义InputFormat实现小文件合并\\文件数据\\out_sequence"));
